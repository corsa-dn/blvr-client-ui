...
import { k as useLocale, b as useAppConfig, t as tv, f as _sfc_main$8 } from './server.mjs';
import { c as _sfc_main$1$1 } from './index-DzWk3S9p.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_DealCard = _sfc_main$1$1;
      _push(ssrRenderComponent(_component_UCarousel, mergeProps({
        ...
        ui: {
          ...
          viewport: "overflow-visible py-4",
          container: "-ms-4",
          item: `ps-4 basis-[82%] sm:basis-[58%] md:basis-[40%] lg:basis-[30%] xl:basis-[25%] z-${_ctx.index}`,
          arrows: "absolute inset-y-0 w-full flex items-center justify-between pointer-events-none ",
          prev: "p-4 !start-1 sm:!start-2 top-1/2 -translate-y-1/2 pointer-events-auto shadow-lg",
          next: "p-4 !end-1 sm:!end-2 top-1/2 -translate-y-1/2 pointer-events-auto shadow-lg"
        },
        ...
        default: withCtx(({ item, index }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_DealCard, {
              key: item,
              deal: item,
            ...
            return [
              (openBlock(), createBlock(_component_DealCard, {
                key: item,
                deal: item,
                loading: __props.loading
              }, null, 8, ["deal", "loading"]))
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/BestDealsCarousel/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as _, _sfc_main$1 as a };
//# sourceMappingURL=index-Codm48qm.mjs.map
