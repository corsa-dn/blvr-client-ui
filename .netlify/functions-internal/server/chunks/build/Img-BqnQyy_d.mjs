...
import { z as withLeadingSlash, r as withTrailingSlash, o as joinURL } from '../nitro/nitro.mjs';
...
import { b as useAppConfig, t as tv, z as useRuntimeConfig, w as __nuxt_component_3 } from './server.mjs';
import 'node:http';
import 'node:https';
import 'node:events';
import 'node:buffer';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(DefineImageTemplate), null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ssrRenderVNode(_push2, createVNode(resolveDynamicComponent(unref(__nuxt_component_3)), mergeProps({
            ...
            return [
              (openBlock(), createBlock(resolveDynamicComponent(unref(__nuxt_component_3)), mergeProps({
                src: refinedSrc.value,
                alt: __props.alt,
                width: __props.width,
                height: __props.height
...
//# sourceMappingURL=Img-BqnQyy_d.mjs.map
