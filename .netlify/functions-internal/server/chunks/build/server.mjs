import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, shallowRef, h, resolveComponent, mergeProps, unref, createVNode, resolveDynamicComponent, computed, withCtx, renderSlot, createBlock, openBlock, ref, watch, toDisplayString, useSlots, inject, createCommentVNode, provide, toValue, getCurrentInstance, onServerPrefetch, toRef, mergeModels, useModel, createTextVNode, hasInjectionContext, isRef, useAttrs, useTemplateRef, nextTick, createElementBlock, cloneVNode, defineAsyncComponent, useSSRContext, shallowReactive, Suspense, Fragment, createApp, renderList, useId, onErrorCaptured, reactive, effectScope, isReadonly, isShallow, isReactive, toRaw, withModifiers, getCurrentScope, markRaw } from 'vue';
import { s as serialize, j as parseQuery, k as klona, l as defuFn, m as defu, n as hasProtocol, o as joinURL, q as isEqual, w as withQuery, r as withTrailingSlash, t as withoutTrailingSlash, v as isScriptProtocol, x as sanitizeStatusCode, y as getContext, e as createError$1, z as withLeadingSlash, A as parseURL, $ as $fetch$1, B as baseURL, C as createHooks, D as executeAsync, E as toRouteMatcher, F as createRouter$1, G as encodeParam, H as encodePath } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-CfcElxso.mjs')
  },
  {
    name: "Contacts",
    path: "/Contacts",
    component: () => import('./Contacts-B1mJ6TBe.mjs')
  },
  {
    name: "deals-id",
    path: "/deals/:id()",
    component: () => import('./_id_-BpMnf-b0.mjs')
  },
  {
    name: "deals",
    path: "/deals",
    component: () => import('./index-BgNfuRDL.mjs')
  }
];
...
const cfg0 = defineAppConfig({
  ui: {
      ...
      compoundVariants: [
        {
          color: "primary",
          variant: "solid",
          class: "text-white bg-[var(--color-brand)] hover:bg-[color-mix(in_oklab,var(--color-brand)_90%,black)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--color-brand)]"
        },
        {
          color: "primary",
          variant: "soft",
          class: "text-[var(--color-brand)] bg-[color-mix(in_oklab,var(--color-brand)_12%,transparent)] hover:bg-[color-mix(in_oklab,var(--color-brand)_18%,transparent)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[color-mix(in_oklab,var(--color-brand)_25%,transparent)]"
        },
        {
          color: "primary",
          variant: "ghost",
          class: "text-[var(--color-brand)] hover:bg-[color-mix(in_oklab,var(--color-brand)_12%,transparent)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[color-mix(in_oklab,var(--color-brand)_25%,transparent)]"
        },
        {
          color: "primary",
          variant: "outline",
          class: "border border-[var(--color-brand)] text-[var(--color-brand)] bg-transparent hover:bg-[color-mix(in_oklab,var(--color-brand)_10%,transparent)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--color-brand)]"
        },
        {
          color: "accent-primary",
          variant: "outline",
          class: "border border-[var(--color-accent-primary)] text-[var(--color-accent-primary)] bg-transparent hover:bg-[color-mix(in_oklab,var(--color-accent-primary)_10%,transparent)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--color-accent-primary)]"
        },
        {
          color: "accent-secondary",
          variant: "outline",
          class: "border border-[var(--color-accent-secondary)] text-[var(--color-accent-secondary)] bg-transparent hover:bg-[color-mix(in_oklab,var(--color-accent-secondary)_10%,transparent)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--color-accent-secondary)]"
        },
        {
          color: "white",
          variant: "outline",
          class: "border border-white text-white bg-transparent hover:bg-white/10 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
        },
        //
        {
          color: "white",
          variant: "solid",
          class: "bg-white text-primary shadow-sm hover:bg-white/90 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
        },
        {
          color: "white",
          variant: "ghost",
        ...
        },
        {
          color: "accent-primary",
          variant: "solid",
          class: "text-white bg-[var(--color-accent-primary)] hover:bg-[color-mix(in_oklab,var(--color-accent-primary)_90%,black)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--color-accent-primary)]"
        },
        {
          color: "accent-secondary",
          variant: "solid",
          class: "text-white bg-[var(--color-accent-secondary)] hover:bg-[color-mix(in_oklab,var(--color-accent-secondary)_90%,black)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--color-accent-secondary)]"
        },
        {
          color: "accent-primary",
          variant: "soft",
          class: "text-[var(--color-accent-primary)] bg-[color-mix(in_oklab,var(--color-accent-primary)_12%,transparent)] hover:bg-[color-mix(in_oklab,var(--color-accent-primary)_18%,transparent)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[color-mix(in_oklab,var(--color-accent-primary)_25%,transparent)]"
        },
        {
          color: "accent-secondary",
          variant: "soft",
          class: "text-[var(--color-accent-secondary)] bg-[color-mix(in_oklab,var(--color-accent-secondary)_12%,transparent)] hover:bg-[color-mix(in_oklab,var(--color-accent-secondary)_18%,transparent)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[color-mix(in_oklab,var(--color-accent-secondary)_25%,transparent)]"
        },
        {
          color: "accent-primary",
          variant: "ghost",
          class: "text-[var(--color-accent-primary)] hover:bg-[color-mix(in_oklab,var(--color-accent-primary)_12%,transparent)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[color-mix(in_oklab,var(--color-accent-primary)_25%,transparent)]"
        },
        {
          color: "accent-secondary",
          variant: "ghost",
          class: "text-[var(--color-accent-secondary)] hover:bg-[color-mix(in_oklab,var(--color-accent-secondary)_12%,transparent)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[color-mix(in_oklab,var(--color-accent-secondary)_25%,transparent)]"
        }
      ]
    },
    input: {
    ...
    tabs: {
      ...
      slots: {
        list: "bg-primary/5 bg-elevated min-h-[${min_input_height}] p-1 gap-1",
        trigger: `${rounded}`,
...
const LazyProseA = defineAsyncComponent(() => import('./A-BaDOiaAz.mjs').then((r) => r["default"] || r.default || r));
const LazyProseAccordionDVue = defineAsyncComponent(() => import('./Accordion.d.vue-BTDBFo2Y.mjs').then((r) => r["default"] || r.default || r));
const LazyProseAccordion = defineAsyncComponent(() => import('./Accordion-BfvM0Rug.mjs').then((r) => r["default"] || r.default || r));
...
function getDisplayValue(items, value, options2 = {}) {
  const { valueKey, labelKey } = options2;
...
function createImage(globalOptions) {
  ...
  const getImage = (input, options2 = {}) => {
    const image = resolveImage(ctx, input, options2);
    return image;
  };
  const $img = ((input, modifiers, options2) => getImage(input, defu({ modifiers }, options2)).url);
...
function resolveImage(ctx, input, options2) {
  ...
  const { setup, defaults } = getProvider(ctx, options2.provider || ctx.options.provider);
...
const ipxRuntime$EmmNRQbFLNPRKJihVE9EPcgQUpEznjyWtKALWFO_45HjE = defineProvider({
...
const imageOptions = {
  ...
  provider: "ipx",
  providers: {
    ["ipx"]: { setup: ipxRuntime$EmmNRQbFLNPRKJihVE9EPcgQUpEznjyWtKALWFO_45HjE, defaults: {} }
  }
};
...
const __nuxt_component_3 = Object.assign(_sfc_main$d, { __name: "NuxtImg" });
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-Bfk2CzjG.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DTI7bChN.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BVHq_w2e.mjs'));
...
export { _export_sfc as _, __nuxt_component_0$2 as a, useAppConfig as b, _sfc_main$e as c, _sfc_main$9 as d, entry_default as default, _sfc_main$b as e, _sfc_main$8 as f, getSlotChildrenText as g, useFormField as h, get as i, useAsyncData as j, useLocale as k, _sfc_main$a as l, _sfc_main$c as m, useRoute as n, usePortal as o, pickLinkProps as p, useFieldGroup as q, useComponentIcons as r, isArrayOfArray as s, tv as t, useHead as u, getDisplayValue as v, __nuxt_component_3 as w, transformUI as x, looseToNumber as y, useRuntimeConfig as z };
