import { b as _sfc_main$3 } from './index-DzWk3S9p.mjs';
import { _ as _sfc_main$2 } from './Tabs-CSFOznZF.mjs';
import { ref, mergeProps, withCtx, unref, isRef, createTextVNode, createVNode, withModifiers, useSlots, toRef, computed, useTemplateRef, createBlock, createCommentVNode, renderSlot, openBlock, Fragment, renderList, toDisplayString, useSSRContext } from 'vue';
...
import { f as _sfc_main$8, b as useAppConfig, o as usePortal, h as useFormField, q as useFieldGroup, r as useComponentIcons, t as tv, s as isArrayOfArray, c as _sfc_main$e, e as _sfc_main$b, i as get, m as _sfc_main$c, v as getDisplayValue } from './server.mjs';
...
const useDealsStore = defineStore("DealsStore", {
  state: () => ({
    property_types: [
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UCard, mergeProps({
        ...
        class: "shadow-lg max-w-200 w-full mx-auto bg-white",
        variant: "solid"
      }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<form${_scopeId}><div class="flex flex-nowrap gap-2"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_UTabs, {
              items: unref(deal_types),
              modelValue: unref(deal_type),
              "onUpdate:modelValue": ($event) => isRef(deal_type) ? deal_type.value = $event : null,
              content: false,
              "default-value": "sell",
              ui: {
            ...
            _push2(ssrRenderComponent(_component_USelect, {
              modelValue: unref(property_type),
              "onUpdate:modelValue": ($event) => isRef(property_type) ? property_type.value = $event : null,
            ...
            _push2(ssrRenderComponent(_component_UButton, {
              ...
              class: "bg-[var(--color-accent-primary)] text-white hover:bg-[color-mix(in_oklab,var(--color-accent-primary)_90%,black)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--color-accent-primary)]",
              ...
              to: {
                ...
                query: {
                  city: unref(city),
                  deal_type: unref(deal_type),
                  property_type: unref(property_type)
                }
              }
            }, {
            ...
            return [
              createVNode("form", {
                onSubmit: withModifiers(($event) => _ctx.$emit("submit", {
                  deal_type: unref(deal_type),
                  property_type: unref(property_type),
                  city: unref(city)
                }), ["prevent"])
              }, [
                createVNode("div", { class: "flex flex-nowrap gap-2" }, [
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/DealsFilter/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as _, _sfc_main$1 as a, useDealsStore as u };
//# sourceMappingURL=index-ZbGCyJKK.mjs.map
