...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "611c786e-1f4a-4249-954d-9cd7d24e6481",
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "/Users/admin/Documents/www/bulvar-client-ui/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  },
  "ipx": {
...
const script = "\"use strict\";(()=>{const t=window,e=document.documentElement,c=[\"dark\",\"light\"],n=getStorageValue(\"localStorage\",\"bulvar-ui-theme\")||\"light\";let i=n===\"system\"?u():n;const r=e.getAttribute(\"data-color-mode-forced\");r&&(i=r),l(i),t[\"__NUXT_COLOR_MODE__\"]={preference:n,value:i,getColorScheme:u,addColorScheme:l,removeColorScheme:d};function l(o){const s=\"\"+o+\"\",a=\"\";e.classList?e.classList.add(s):e.className+=\" \"+s,a&&e.setAttribute(\"data-\"+a,o)}function d(o){const s=\"\"+o+\"\",a=\"\";e.classList?e.classList.remove(s):e.className=e.className.replace(new RegExp(s,\"g\"),\"\"),a&&e.removeAttribute(\"data-\"+a)}function f(o){return t.matchMedia(\"(prefers-color-scheme\"+o+\")\")}function u(){if(t.matchMedia&&f(\"\").media!==\"not all\"){for(const o of c)if(f(\":\"+o).matches)return o}return\"light\"}})();function getStorageValue(t,e){switch(t){case\"localStorage\":return window.localStorage.getItem(e);case\"sessionStorage\":return window.sessionStorage.getItem(e);case\"cookie\":return getCookie(e);default:return null}}function getCookie(t){const c=(\"; \"+window.document.cookie).split(\"; \"+t+\"=\");if(c.length===2)return c.pop()?.split(\";\").shift()}";

const _De_ZMujXuFcJVc7ab83qzVGCfBQqGPkRRavGBWNTdwQ = (function(nitro) {
...
const plugins = [
  _De_ZMujXuFcJVc7ab83qzVGCfBQqGPkRRavGBWNTdwQ
];
...
const _SeshKF = defineCachedEventHandler(async (event) => {
...
const _uHKqyS = eventHandler(async (event) => {
...
const _af8ZdF = eventHandler(async (event) => {
...
const _8Cvm74 = lazyEventHandler(() => {
...
const _lazy_PN4zUC = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_PN4zUC, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _SeshKF, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/sql_dump.txt', handler: _uHKqyS, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/query', handler: _af8ZdF, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _8Cvm74, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_PN4zUC, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch$1 as $, parseURL as A, baseURL as B, createHooks as C, executeAsync as D, toRouteMatcher as E, createRouter$1 as F, encodeParam as G, encodePath as H, handler as I, getResponseStatus as a, buildAssetsURL as b, getQuery as c, defineRenderHandler as d, createError$1 as e, destr as f, getResponseStatusText as g, getRouteRules as h, useNitroApp as i, parseQuery as j, klona as k, defuFn as l, defu as m, hasProtocol as n, joinURL as o, publicAssetsURL as p, isEqual as q, withTrailingSlash as r, serialize$1 as s, withoutTrailingSlash as t, useRuntimeConfig as u, isScriptProtocol as v, withQuery as w, sanitizeStatusCode as x, getContext as y, withLeadingSlash as z };
